...
sys.path.append("../")
from tools.confluence_config import (
...
class DataLoader:
    ...
    def save_to_db(self, splitted_docs, embeddings):
        ...
        # db.persist() - LangChainDeprecationWarning: Since Chroma 0.4.x the manual persistence method is no longer supported as docs are automatically persisted.
        return db
